...
func TestGinLoggerWithConfig(t *testing.T) {
	...
	conf := GinLoggerConfig{
		...
		Formatter: func(c *gin.Context, m GinLogExtends) string {
			return fmt.Sprintln(c.Writer.Status(), c.Request.RequestURI)
		},
		TraceIDFunc: func(*gin.Context) string { return "xx-xx-xx-xx" },
		SkipPaths:   []string{},
	}
