...
func main() {
	...
	// Output:
	// {"level":"DEBUG","time":"2020-04-15 18:39:37.548323","logger":"logit","caller":"example/logger.go:main:48","msg":"emptyOptionsLogger","pid":68701}
	...
	options := logit.Options{
		...
		AtomicLevelServer: logit.AtomicLevelServerOption{Addr: ":9999"},
	}
	optionsLogger, _ := logit.NewLogger(options)
	optionsLogger.Debug("optionsLogger")
	// Output:
	// {"level":"DEBUG","time":"2020-04-15 18:39:37.548363","logger":"logit","caller":"example/logger.go:main:67","msg":"optionsLogger","pid":68701}
